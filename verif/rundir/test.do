...
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/sys_rst
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/sys_clk
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/uart_rx
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/uart_tx
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/divisor
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_data
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_done
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_data
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_wr
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_done
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/enable16_counter
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/enable16
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/uart_rx1
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/uart_rx2
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_busy
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_count16
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_bitcount
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/rx_reg
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_busy
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_bitcount
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_count16
add wave -position end  sim:/dig_core_tb/dut/i_uart_transcevier/tx_reg
log * -r
run 10ms
# 161
